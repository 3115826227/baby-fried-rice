...
func IsSuper(userMeta *UserMeta) bool {
	return userMeta.IsSuper == "1"
}
...
func StringsDuplicateRemove(slice []string) (resp []string) {
...
func IntsDuplicateRemove(slice []int) (resp []int) {
